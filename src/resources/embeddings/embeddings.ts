...
import * as MultimodalAPI from './multimodal';
import { Multimodal, MultimodalCreateParams, MultimodalCreateResponse } from './multimodal';
import { APIPromise } from '../../core/api-promise';
import { RequestOptions } from '../../internal/request-options';

export class Embeddings extends APIResource {
  multimodal: MultimodalAPI.Multimodal = new MultimodalAPI.Multimodal(this._client);
...
Embeddings.Multimodal = Multimodal;
