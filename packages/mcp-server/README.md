...
```sh
export VOYAGE_API_KEY="My API Key"
npx -y voyage-mcp@latest
```
...
{
  "mcpServers": {
    "unofficial_demo_voyage_ai_api": {
      "command": "npx",
      "args": ["-y", "voyage-mcp", "--client=claude", "--tools=all"],
      "env": {
...
[![Add to Cursor](https://cursor.com/deeplink/mcp-install-dark.svg)](https://cursor.com/en-US/install-mcp?name=voyage-mcp&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyIteSIsInZveWFnZS1tY3AiXSwiZW52Ijp7IlZPWUFHRV9BUElfS0VZIjoiU2V0IHlvdXIgVk9ZQUdFX0FQSV9LRVkgaGVyZS4ifX0)
...
[Open VS Code](https://vscode.stainless.com/mcp/%7B%22name%22%3A%22voyage-mcp%22%2C%22command%22%3A%22npx%22%2C%22args%22%3A%5B%22-y%22%2C%22voyage-mcp%22%5D%2C%22env%22%3A%7B%22VOYAGE_API_KEY%22%3A%22Set%20your%20VOYAGE_API_KEY%20here.%22%7D%7D)
...
| ----------------------- | ------------------------ | --------------- |
| `Authorization: Bearer` | `apiKey` | ApiKeyAuth |
